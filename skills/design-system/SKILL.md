...
| Component Specs | moved → `design-system-2026/references/component-specs.md` (enriched 2026) |
| States & Variants | moved → `design-system-2026/references/states-and-variants.md` (enriched 2026) |
| Tailwind Integration | moved → `design-system-2026/references/tailwind-integration.md` (enriched 2026) |
