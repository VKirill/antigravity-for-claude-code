...
- You need GTM container / tag management — load `gtm` for resource hierarchy and CRUD operations
...
- `gtm` — GTM container / tag management (depends on this skill for credential bootstrap)
